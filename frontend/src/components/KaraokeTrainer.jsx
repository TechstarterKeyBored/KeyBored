...
const KaraokeTrainer = () => {
  ...
  const songs = [
    ...
    },
    {
      ...
      lyrics: [
        ...
        { time: 36.6, text: "love remained a drug thats the high and not the pill" },
        { time: 43.5, text: "but did you know that when it snows" },
        { time: 46.1, text: "my eyes become large and the light that you shine can be seen" },
        { time: 53.6, text: "baby i compare you to a kiss from a rose on the gray" },
        { time: 61, text: "the more i get of you the stranger it feels yeah" },
        { time: 66.6, text: "and now that your rose is in bloom" },
        { time: 70.7, text: "a light hits the gloom on the gray" },
        { time: 88, text: "there is so much a man can tell you so much he can say" },
        { time: 94, text: "you remain my power my pleasure my pain baby" },
        { time: 102.2, text: "to me youre like a growing addiction that i cant deny" },
        { time: 106.5, text: "wont you tell me is that healthy baby" },
        { time: 110.5, text: "but did you know that when it snows" },
        { time: 113.2, text: "my eyes become large and the light that you shine can be seen" },
        { time: 121, text: "baby i compare you to a kiss from a rose on the gray" },
        { time: 128, text: "the more i get of you the stranger it feels" },
        { time: 133.4, text: "now that your rose is in bloom" },
        { time: 137.9, text: "a light hits the gloom on the gray" },
        { time: 160, text: "ive been kissed by a rose on the gray" },
        { time: 166.5, text: "ive been kissed by a rose on the gray" },
        { time: 170.8, text: "ive been kissed by a rose on the gray" },
        { time: 177.3, text: "ive been kissed by a rose on the gray" },
        { time: 183.1, text: "there is so much a man can tell you so much he can say" },
        { time: 188.3, text: "you remain my power my pleasure my pain" },
        { time: 194.9, text: "to me youre like a growing addiction that i cant deny" },
        { time: 199.3, text: "wont you tell me is that healthy baby" },
        { time: 203.5, text: "but did you know that when it snows" },
        { time: 206.1, text: "my eyes become large and the light that you shine can be seen" },
        { time: 214.2, text: "baby i compare you to a kiss from a rose on the gray" },
        { time: 221, text: "the more i get of you the stranger it feels" },
        { time: 226.9, text: "now that your rose is in bloom" },
        { time: 231.2, text: "a light hits the gloom on the gray" },
        { time: 235.3, text: "yes i compare you to a kiss from a rose on the gray" },
        { time: 240.4, text: "the more i get of you the stranger it feels" },
        { time: 246.2, text: "now that your rose is in bloom" },
        { time: 249.8, text: "a light hits the gloom on the gray" },
        { time: 264.6, text: "now that your rose is in bloom" },
        { time: 269.2, text: "a light hits the gloom on the gray" },
      ],
    },
    {
      ...
      lyrics: [
        ...
        { time: 27, text: "youre frozen" },
        { time: 29, text: "when your hearts not open" },
        { time: 37, text: "youre so consumed with how much you get" },
  ...
  if (!selectedSong)
    return (
      <div className="grid w-1/2 rounded-2xl border-2 border-gray-400 grid-cols-2 gap-4 p-6 bg-gray-800 text-white mx-auto mt-10 shadow-2xl shadow-fuchsia-950">
        {songs.map((song) => (
          <button
            key={song.title}
