  ...
  const songs = [
    ...
    },
    {
      ...
      lyrics: [
        ...
        {
          time: 17.8,
          text: "Feels like Im lost in a deep cloud of heavenly scent",
        },
        { time: 29, text: "Touching discovering you" },
        {
          time: 47.1,
          text: "Those days of warm rains come rushing back to me",
        },
        { time: 55.7, text: "Miles of windless summer nights" },
        {
          time: 64.7,
          text: "Secret moments shared within the heat of the afternoon",
        },
        ...
        {
          time: 163,
          text: "Near and far and always everywhere and everything",
        },
