...
function TypingTrainer() {
  ...
  return (
    <div className="flex flex-col items-center gap-4 p-10 w-4xl mx-auto">
      <h1 className="text-2xl font-bold text-amber-100">Willkommen auf TypingTrainer</h1>
      ...
      <div className="flex flex-row gap-5">
        <button
          ...
          className="w-96 text-amber-100 font-bold text-xl p-3 bg-gray-900 border-1 border-black rounded-2xl shadow-fuchsia-950 shadow-lg hover:scale-104 hover:shadow-xl transition-all mt-4"
        >
          TypingGame
        </button>
        <button
